...
function LoginPage(props) {
    ...
    return (
        <div className="flex flex-col items-center text-center bg-gray-50 shadow-lg rounded-lg mx-48">
            <h1 className="text-3xl font-bold pt-8">Welcome back !
                <br />
                <span className="text-lg font-normal">Log back in to start planning your next adventure</span>
            </h1>
            <form className="flex flex-col py-8 gap-8 mx-48" onSubmit={handleLoginSubmit}>
            ...
            <div className="flex flex-row gap-2 pt-4 pb-8">
                ...
                <Link className="hover:text-green-pine text-md" to={"/signup"}> Sign Up</Link>
            </div>
        </div>
    )
}
